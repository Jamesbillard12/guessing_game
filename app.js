function testEvent(){
  ...
  // As a developer, I want to add an eighth question to my guessing game that
  // accepts multiple possible correct answers that are stored in an array, for
  // instance, "Can you guess a state that I have lived in besides Washington?",
  // so that even more of my programming skills are showcased. For now, I will
  // structure this question so that the user has six tries to get a single correct
  // answer, and upon exhausting those tries OR getting a correct answer, displays
  // a message to the user indicating all of the possible correct answers.

  var myPlacesAnswers = ["ENGLAND", "FRANCE", "CANADA", "USA", "UNITED STATES OF AMERICA", "US", "UNITED STATES"]
  var userPlacesAnswers = prompt("Last one! Can you guess what ")
